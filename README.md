...
```
### Example
example for CyberNERQA dataset
```
...
```
@article{,
  title={FortiQA: Adaptive Edge-Cloud Framework for Cybersecurity Question-Answering Using LLMs},
  author={Gaddi, Matilda and Gungor, Onat and Rosing, Tajana},
